              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Icon(Icons.account_balance_wallet_rounded, size: 80, color: Colors.white),
                  ),
                  SizedBox(height: 20),
                  Text(
                    "SpeakWallet",
                  ...
                  Text(
                    "AI Finance Tracker",
                    style: TextStyle(fontSize: 16, color: Colors.teal.shade100, fontWeight: FontWeight.w500),
                  ),
                  SizedBox(height: 50),
                    ...
                    child: Column(
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.teal.shade900),
                        ),
                        SizedBox(height: 8),
                        Text(
                          _isOtpSent ? "Auto-detecting the 4-digit code..." : "Login with your phone number",
                        ...
                        if (!_isOtpSent) ...[
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: Icon(Icons.phone_iphone_rounded, color: Colors.teal.shade700),
                              filled: true,
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _isLoading
                                  ...
                                  : Text("Send OTP", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                            ),
                          ),
                        ] else ...[
                          TextField(
                            ...
                            maxLength: 4,
                            textAlign: TextAlign.center,
                            style: TextStyle(fontSize: 32, letterSpacing: 16, fontWeight: FontWeight.w900, color: Colors.teal.shade900),
                            decoration: InputDecoration(
                              counterText: "",
                              hintText: "••••",
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: _isLoading
                                  ? SizedBox(height: 25, width: 25, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 3))
                                  : Text("Verify & Login", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                            ),
                          ),
                          SizedBox(height: 10),
                          TextButton(
                            ...
                            child: Text("Change Phone Number", style: TextStyle(color: Colors.teal.shade700, fontWeight: FontWeight.bold)),
                          )
                        ]
                      ],
                    ),
